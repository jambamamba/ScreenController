...
public:
    ...
    static constexpr int _retry_request_frame_timeout_ms = 800;
    static constexpr int _send_next_frame_timeout_ms = 100;//osm TODO make this variable based on how many packets are getting dropped
