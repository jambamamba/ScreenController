...
public:
    ...
    static constexpr int _datagram_size = (32*1024) - sizeof(Command); // to determine MTU size, ping -s $((1500 - 28)) -M do 192.168.1.22 -c 1, or on Internet ping -s $((96 - 28)) -M do 8.8.8.8 -c 1
    static constexpr int _ring_buffer_size = 10000;
    static constexpr int _retry_request_frame_timeout_ms = 1000;//osm TODO make this variable based on how many packets are getting dropped
    static constexpr int _send_next_frame_timeout_ms = 10;
